            ...
            <div className="min-h-screen">
                ...
                <section className="text-center py-10 bg-customcolor1 text-white">
                    <h1 className="text-4xl font-bold">
                        Programme Officiel de l&apos;Abissa 2025
                    </h1>
                    <p className="mt-2 text-lg">
                        Du 19 octobre au 2 novembre 2025 - Grand-Bassam, Côte
                        d&apos;Ivoire
                    </p>
                </section>
                ...
                <section className="max-w-6xl mx-auto px-4 py-10">
                    <h2 className="text-2xl font-semibold text-customcolor1 mb-6 text-center">
                        Détail des Journées
                    </h2>
